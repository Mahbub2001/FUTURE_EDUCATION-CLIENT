...
const Login = () => {
  const { signIn, setLoading, googleSignIn, handleGithubSignIn } =
  ...
  const handleSubmit = (event) => {
    ...
    signIn(userInfo.email, userInfo.password)
      .then((result) => {
        ...
        toast.success("successfully login", { toastId: "toast2" });
        console.log(result);
        form.reset();
        ...
        <div className="bg-gray-100 rounded-b-lg py-12 px-4 lg:px-24">
          ...
          <form onSubmit={handleSubmit} className="mt-6">
            ...
            <div className="mt-4 flex items-center justify-between text-gray-500">
              ...
              <div>
                <Link
                  className="text-red-900 font-semibold hover:text-red-400 "
                  to="/forget-password"
                >
                  Forgot Password
                </Link>
            ...
            <p className="text-center">
              ...
              <Link
                to="/register"
                className="text-red-800 font-semibold hover:text-red-400"
              >
                Register Here
              </Link>
            </p>
